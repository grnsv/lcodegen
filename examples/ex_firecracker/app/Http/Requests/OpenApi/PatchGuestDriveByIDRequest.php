 ...
 */
abstract class PatchGuestDriveByIDRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\PartialDrive|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\PartialDrive::fromArray($validated);
        }
