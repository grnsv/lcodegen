 ...
 */
abstract class ConnectCoreV1PostNamespacedPodExecRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\ConnectCoreV1PostNamespacedPodExecParams|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\ConnectCoreV1PostNamespacedPodExecParams::fromArray($validated);
        }
