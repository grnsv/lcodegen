 ...
 */
abstract class RevokeChatInviteLinkRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\RevokeChatInviteLink|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\RevokeChatInviteLink::fromArray($validated);
        }
