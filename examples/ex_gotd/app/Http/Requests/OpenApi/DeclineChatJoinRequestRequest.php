 ...
 */
abstract class DeclineChatJoinRequestRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\DeclineChatJoinRequest|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\DeclineChatJoinRequest::fromArray($validated);
        }
