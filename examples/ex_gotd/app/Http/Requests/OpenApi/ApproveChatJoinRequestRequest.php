 ...
 */
abstract class ApproveChatJoinRequestRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\ApproveChatJoinRequest|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\ApproveChatJoinRequest::fromArray($validated);
        }
