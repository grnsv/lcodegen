 ...
 */
abstract class SetStickerPositionInSetRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\SetStickerPositionInSet|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\SetStickerPositionInSet::fromArray($validated);
        }
