 ...
 */
abstract class SetPassportDataErrorsRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\SetPassportDataErrors|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\SetPassportDataErrors::fromArray($validated);
        }
