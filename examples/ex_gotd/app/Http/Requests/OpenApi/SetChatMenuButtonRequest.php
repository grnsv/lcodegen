 ...
 */
abstract class SetChatMenuButtonRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\SetChatMenuButton|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\SetChatMenuButton::fromArray($validated);
        }
