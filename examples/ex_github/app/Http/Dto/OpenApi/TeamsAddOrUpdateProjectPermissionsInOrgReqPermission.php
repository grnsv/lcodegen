 ...
 */
enum TeamsAddOrUpdateProjectPermissionsInOrgReqPermission: string
{
    case TeamsAddOrUpdateProjectPermissionsInOrgReqPermissionRead = 'read';
    case TeamsAddOrUpdateProjectPermissionsInOrgReqPermissionWrite = 'write';
    case TeamsAddOrUpdateProjectPermissionsInOrgReqPermissionAdmin = 'admin';
}
