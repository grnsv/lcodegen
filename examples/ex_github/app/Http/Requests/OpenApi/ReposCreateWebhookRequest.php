 ...
 */
abstract class ReposCreateWebhookRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\ReposCreateWebhookReq|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\ReposCreateWebhookReq::fromArray($validated);
        }
