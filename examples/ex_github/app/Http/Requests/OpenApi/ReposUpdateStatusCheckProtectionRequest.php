 ...
 */
abstract class ReposUpdateStatusCheckProtectionRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\ReposUpdateStatusCheckProtectionReq|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\ReposUpdateStatusCheckProtectionReq::fromArray($validated);
        }
