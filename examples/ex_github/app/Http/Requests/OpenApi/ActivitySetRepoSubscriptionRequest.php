 ...
 */
abstract class ActivitySetRepoSubscriptionRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\ActivitySetRepoSubscriptionReq|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\ActivitySetRepoSubscriptionReq::fromArray($validated);
        }
