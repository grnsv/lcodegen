 ...
 */
abstract class IssuesUpdateCommentRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\IssuesUpdateCommentReq|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\IssuesUpdateCommentReq::fromArray($validated);
        }
