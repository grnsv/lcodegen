 ...
 */
abstract class ProjectsUpdateColumnRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\ProjectsUpdateColumnReq|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\ProjectsUpdateColumnReq::fromArray($validated);
        }
