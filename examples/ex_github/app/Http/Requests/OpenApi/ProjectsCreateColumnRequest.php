 ...
 */
abstract class ProjectsCreateColumnRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\ProjectsCreateColumnReq|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\ProjectsCreateColumnReq::fromArray($validated);
        }
