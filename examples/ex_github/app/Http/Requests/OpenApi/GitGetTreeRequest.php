 ...
 */
abstract class GitGetTreeRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\GitGetTreeParams|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\GitGetTreeParams::fromArray($validated);
        }
