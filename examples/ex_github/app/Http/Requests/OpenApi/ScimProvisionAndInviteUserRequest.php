 ...
 */
abstract class ScimProvisionAndInviteUserRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\ScimProvisionAndInviteUserReq|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\ScimProvisionAndInviteUserReq::fromArray($validated);
        }
