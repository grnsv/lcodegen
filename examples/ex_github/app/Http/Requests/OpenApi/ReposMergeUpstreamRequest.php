 ...
 */
abstract class ReposMergeUpstreamRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\ReposMergeUpstreamReq|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\ReposMergeUpstreamReq::fromArray($validated);
        }
