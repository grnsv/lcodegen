 ...
 */
abstract class GistsCreateCommentRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\GistsCreateCommentReq|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\GistsCreateCommentReq::fromArray($validated);
        }
