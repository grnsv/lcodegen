 ...
 */
abstract class ProjectsUpdateCardRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\ProjectsUpdateCardReq|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\ProjectsUpdateCardReq::fromArray($validated);
        }
