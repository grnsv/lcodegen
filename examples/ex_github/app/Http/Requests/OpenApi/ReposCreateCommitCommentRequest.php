 ...
 */
abstract class ReposCreateCommitCommentRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\ReposCreateCommitCommentReq|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\ReposCreateCommitCommentReq::fromArray($validated);
        }
