 ...
 */
abstract class GistsUpdateCommentRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\GistsUpdateCommentReq|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\GistsUpdateCommentReq::fromArray($validated);
        }
