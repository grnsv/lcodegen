 ...
 */
abstract class ScimUpdateAttributeForUserRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\ScimUpdateAttributeForUserReq|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\ScimUpdateAttributeForUserReq::fromArray($validated);
        }
