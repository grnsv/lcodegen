 ...
 */
abstract class ReposCreatePagesSiteRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\ReposCreatePagesSiteReq|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\ReposCreatePagesSiteReq::fromArray($validated);
        }
