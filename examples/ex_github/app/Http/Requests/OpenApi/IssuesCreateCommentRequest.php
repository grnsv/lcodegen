 ...
 */
abstract class IssuesCreateCommentRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\IssuesCreateCommentReq|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\IssuesCreateCommentReq::fromArray($validated);
        }
