 ...
 */
abstract class ReposCreateDeployKeyRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\ReposCreateDeployKeyReq|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\ReposCreateDeployKeyReq::fromArray($validated);
        }
