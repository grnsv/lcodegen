 ...
 */
abstract class ReposCreateAutolinkRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\ReposCreateAutolinkReq|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\ReposCreateAutolinkReq::fromArray($validated);
        }
