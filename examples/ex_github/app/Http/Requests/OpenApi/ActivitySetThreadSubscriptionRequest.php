 ...
 */
abstract class ActivitySetThreadSubscriptionRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\ActivitySetThreadSubscriptionReq|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\ActivitySetThreadSubscriptionReq::fromArray($validated);
        }
