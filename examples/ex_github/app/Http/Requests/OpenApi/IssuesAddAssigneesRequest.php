 ...
 */
abstract class IssuesAddAssigneesRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\IssuesAddAssigneesReq|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\IssuesAddAssigneesReq::fromArray($validated);
        }
