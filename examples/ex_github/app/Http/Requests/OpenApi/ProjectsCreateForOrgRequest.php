 ...
 */
abstract class ProjectsCreateForOrgRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\ProjectsCreateForOrgReq|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\ProjectsCreateForOrgReq::fromArray($validated);
        }
