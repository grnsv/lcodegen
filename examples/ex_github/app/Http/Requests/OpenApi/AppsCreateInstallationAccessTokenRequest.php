 ...
 */
abstract class AppsCreateInstallationAccessTokenRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\AppsCreateInstallationAccessTokenReq|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\AppsCreateInstallationAccessTokenReq::fromArray($validated);
        }
