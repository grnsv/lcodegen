 ...
 */
abstract class MarketSearchByFigiGetRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\MarketSearchByFigiGetParams|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\MarketSearchByFigiGetParams::fromArray($validated);
        }
