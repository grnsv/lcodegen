 ...
 */
abstract class CreateFileRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\CreateFileRequestMultipart|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\CreateFileRequestMultipart::fromArray($validated);
        }
