...
func (s *InlineQueryResultAudio) SetFake() {
	...
	{
		{
			s.AudioURL = url.URL{Scheme: "https", Host: "github.com", Path: "/grnsv/lcodegen"}
		}
	}
	{
		{
...
func (s *InlineQueryResultDocument) SetFake() {
	...
	{
		{
			s.DocumentURL = url.URL{Scheme: "https", Host: "github.com", Path: "/grnsv/lcodegen"}
		}
	}
	{
		{
...
func (s *InlineQueryResultGif) SetFake() {
	...
	{
		{
			s.GIFURL = url.URL{Scheme: "https", Host: "github.com", Path: "/grnsv/lcodegen"}
		}
	}
	{
		{
	...
	{
		{
			s.ThumbURL = url.URL{Scheme: "https", Host: "github.com", Path: "/grnsv/lcodegen"}
		}
	}
	{
		{
...
func (s *InlineQueryResultMpeg4Gif) SetFake() {
	...
	{
		{
			s.Mpeg4URL = url.URL{Scheme: "https", Host: "github.com", Path: "/grnsv/lcodegen"}
		}
	}
	{
		{
...
func (s *InlineQueryResultPhoto) SetFake() {
	...
	{
		{
			s.PhotoURL = url.URL{Scheme: "https", Host: "github.com", Path: "/grnsv/lcodegen"}
		}
	}
	{
		{
...
func (s *InlineQueryResultVideo) SetFake() {
	...
	{
		{
			s.VideoURL = url.URL{Scheme: "https", Host: "github.com", Path: "/grnsv/lcodegen"}
		}
	}
	{
		{
...
func (s *InlineQueryResultVoice) SetFake() {
	...
	{
		{
			s.VoiceURL = url.URL{Scheme: "https", Host: "github.com", Path: "/grnsv/lcodegen"}
		}
	}
	{
		{
