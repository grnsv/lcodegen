 ...
 */
abstract class GetChatAdministratorsRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\GetChatAdministrators|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\GetChatAdministrators::fromArray($validated);
        }
