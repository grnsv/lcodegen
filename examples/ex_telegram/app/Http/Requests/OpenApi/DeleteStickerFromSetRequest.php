 ...
 */
abstract class DeleteStickerFromSetRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\DeleteStickerFromSet|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\DeleteStickerFromSet::fromArray($validated);
        }
