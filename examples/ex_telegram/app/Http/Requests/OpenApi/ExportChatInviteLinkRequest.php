 ...
 */
abstract class ExportChatInviteLinkRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\ExportChatInviteLink|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\ExportChatInviteLink::fromArray($validated);
        }
