 ...
 */
abstract class UnpinAllChatMessagesRequest extends FormRequest
{
    /**
     ...
     * @param mixed $default
     * @return Dto\UnpinAllChatMessages|mixed
     */
    public function validated($key = null, $default = null): mixed
    {
        $validated = parent::validated($key, $default);
        if ($key === null) {
            return Dto\UnpinAllChatMessages::fromArray($validated);
        }
